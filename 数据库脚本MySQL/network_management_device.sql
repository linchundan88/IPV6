...
CREATE TABLE `device` (
  ...
  `community_read` varchar(30) DEFAULT NULL,
  `community_write` varchar(30) DEFAULT NULL,
  `device_type` varchar(45) DEFAULT NULL,
  `snmp_port` smallint(6) DEFAULT NULL,
  `get_arp` tinyint(4) DEFAULT '1',
  `get_mac_address` tinyint(4) DEFAULT '1',
  `sysName` varchar(50) DEFAULT NULL,
  `sysContract` varchar(50) DEFAULT NULL,
