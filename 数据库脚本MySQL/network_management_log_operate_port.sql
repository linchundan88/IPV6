...
--
-- Table structure for table `log_operate_port`
--

DROP TABLE IF EXISTS `log_operate_port`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `log_operate_port` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
  `device_ip` varchar(15) NOT NULL,
  `ifindex` int(6) NOT NULL,
  `ifDescr` varchar(80) DEFAULT NULL,
  `log_content` varchar(10) NOT NULL,
